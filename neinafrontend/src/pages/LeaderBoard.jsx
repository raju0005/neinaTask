...
const Leaderboard = () => {
    ...
    useEffect(() => {
        setLoading(true);
        axios
            .get("https://neina-task-server.vercel.app/api/user/v1/get-users")
    ...
    const fetchHistoryForPeriod = useCallback(async () => {
        ...
        try {
            const response = await axios.get(
                `https://neina-task-server.vercel.app/api/user/v1/${endpoint}`
            );
            setHistory({
    ...
    const viewHistory = async (username) => {
        ...
        try {
            const response = await axios.post(
                "https://neina-task-server.vercel.app/api/user/v1/your-history",
                { username }
            );
            setHistory({
